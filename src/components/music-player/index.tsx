...
import { DisabledPlayer, Player } from '@/components/music-player/player'
...
export const MusicPlayer = () => {
  ...
  if (!song || !song.songPath || !player.activeId || !user) {
    return (
      <div className="fixed bottom-0 h-[80px] w-full bg-white px-4 py-2 dark:bg-black dark:opacity-50">
        <DisabledPlayer />
      </div>
    )
  }
